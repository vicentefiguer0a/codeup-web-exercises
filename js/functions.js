...
let helloMessage = sayHello("Vicente");
...
function applyDiscount(originalPrice, discountPercent) {
    let difference = originalPrice * discountPercent; // Calculates amount discounted.
    return originalPrice - difference; // Gives user new discounted total.
}
